    ...
    with open(i+'processNoAffinityNode34.sh', 'w') as f:
        for line in linesV1:
            if(j==2):
                ...
                f.write(line)
                f.write('\n')
                f.write("#SBATCH --output="+i+"processNoAffinity-db12-Experiment1-Node34")
                f.write('\n')
                j = j + 1
            elif(j==6):
                f.write(line)
                ...
                f.write(line)
                f.write('\n')
                f.write("time python3 exe.py $((0 + "+str(int(128/int(i)))+"*$i)) $(("+str(int(128/int(i) - 1))+" + "+str(int(128/int(i)))+"*$i )) &")
                f.write('\n')
                j = j + 1
    ...
    with open(i+'processAffinityNode34.sh', 'w') as f:
        for line in linesV2:
            if(j==2):
                ...
                f.write(line)
                f.write('\n')
                f.write("#SBATCH --output="+i+"processAffinity-db12-Experiment1-Node34")
                f.write('\n')
                j = j + 1
            elif(j==6):
                f.write(line)
                ...
                f.write(line)
                f.write('\n')
                f.write("time taskset -c $(($i%64)) python3 exe.py $((0 + "+str(int(128/int(i)))+"*$i)) $(("+str(int(128/int(i) - 1))+" + "+str(int(128/int(i)))+"*$i )) &")
                f.write('\n')
                j = j + 1
    ...
    with open(i+'processNoAffinityNode40.sh', 'w') as f:
        for line in linesV3:
            if(j==2):
                ...
                f.write(line)
                f.write('\n')
                f.write("#SBATCH --output="+i+"processNoAffinity-db12-Experiment1-Node40")
                f.write('\n')
                j = j + 1
            elif(j==7):
                f.write(line)
    ...
    with open(i+'processAffinityNode40.sh', 'w') as f:
        for line in linesV4:
            if(j==2):
                ...
                f.write(line)
                f.write('\n')
                f.write("#SBATCH --output="+i+"processAffinity-db12-Experiment1-Node40")
                f.write('\n')
                j = j + 1
            elif(j==7):
                f.write(line)
                ...
                f.write(line)
                f.write('\n')
                f.write("time taskset -c $i python3 exe.py $((0 + "+str(int(128/int(i)))+"*$i)) $(("+str(int(128/int(i) - 1))+" + "+str(int(128/int(i)))+"*$i )) &")
                f.write('\n')
                j = j + 1
        ...
        with open(i+'processNoAffinityNode34-repli'+str(numRepli)+'.sh', 'w') as f:
            for line in linesV1:
                if(j==2):
                    ...
                    f.write(line)
                    f.write('\n')
                    f.write("#SBATCH --output="+i+"processNoAffinity-db12-Experiment1-Node34-replication"+str(numRepli))
                    f.write('\n')
                    j = j + 1
                elif(j==6):
                    f.write(line)
        ...
        with open(i+'processAffinityNode34-repli'+str(numRepli)+'.sh', 'w') as f:
            for line in linesV2:
                if(j==2):
                    ...
                    f.write(line)
                    f.write('\n')
                    f.write("#SBATCH --output="+i+"processAffinity-db12-Experiment1-Node34-replication"+str(numRepli))
                    f.write('\n')
                    j = j + 1
                elif(j==6):
                    f.write(line)
        ...
        with open(i+'processNoAffinityNode40-repli'+str(numRepli)+'.sh', 'w') as f:
            for line in linesV3:
                if(j==2):
                    ...
                    f.write(line)
                    f.write('\n')
                    f.write("#SBATCH --output="+i+"processNoAffinity-db12-Experiment1-Node40-replication"+str(numRepli))
                    f.write('\n')
                    j = j + 1
                elif(j==7):
                    f.write(line)
        ...
        with open(i+'processAffinityNode40-repli'+str(numRepli)+'.sh', 'w') as f:
            for line in linesV4:
                if(j==2):
                    ...
                    f.write(line)
                    f.write('\n')
                    f.write("#SBATCH --output="+i+"processAffinity-db12-Experiment1-Node40-replication"+str(numRepli))
                    f.write('\n')
                    j = j + 1
                elif(j==7):
                    f.write(line)
